    ...
    <div class="container">
      <div class="main">
        ...
        <div class="text-h4">经营特点:
          <span class="text-紫磨真金">鄙人属于游击队开发者，迎宾保安、会计出纳、董事长总经理……哈是我一个人！交货周期会相对较长，价格会相对较低，聊得投机，免费定制也不是不可以~~(比如说，您对自己的业务有很清晰的认知，确切的知道什么样的软件可以降低工作难度、提升效率，即使我这次不能赚钱，增加一个成功的案例也不错)</span>
        </div>
